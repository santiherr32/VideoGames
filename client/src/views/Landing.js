    ...
    return (
        <main className='landing-container'>
            <section className='landing__hero'>
                <Logo></Logo>
                <Link className='landing__home-btn' to='/home'>
                    <span>Enter</span>
            ...
            <picture className='landing__characters-image'>
                <img src="https://i.ibb.co/1scr40C/wallpaper2you-420693.jpg" alt="Video games characters" />
            </picture>
        </main>
    )
}
